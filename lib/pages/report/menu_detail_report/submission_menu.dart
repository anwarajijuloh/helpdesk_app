                  ...
                  child: GestureDetector(
                    child: MySubmissionCard(
                      ...
                      date: DateFormat("EEEE, d MMM y\nHH.mm", "id_id")
                          .format(submission.createTime),
                      status: '${submission.status}',
                      estimasi: submission.estimasi == null ? 'tidak' : submission.estimasi! ,
                      satuan: submission.satuanEstimasi == null ? 'ada' : submission.satuanEstimasi!,
                    ),
                    onTap: () {
